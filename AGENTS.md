...
Use this file as the working guide for LLM-driven changes. 
...
- This menu is designed to be data-driven, so be cautious when considering hardcoding. Is there an api exposed from the game that lets us fetch this data? etc.
