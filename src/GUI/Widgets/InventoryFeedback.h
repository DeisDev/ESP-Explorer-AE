...
namespace ESPExplorerAE::InventoryFeedback
{
    ...
    std::string Message(InventoryRejection rejection, const Localize& localize)
    {
        ...
        case InventoryRejection::AmbiguousInstance: return localize("Inventory", "sInstanceRequired", "Choose an instance to equip, use, or duplicate. Removal applies to the group.");
